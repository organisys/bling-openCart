...
class ControllerModuleBling extends Controller {
	...
	public function load_sales_orders(){
		...
		$this->data['column_order_id'] = htmlspecialchars('N� do pedido');
		$this->data['column_customer'] = 'Cliente';
		$this->data['column_status'] = htmlspecialchars('Situa��o');
		$this->data['column_total'] = 'Total';
		$this->data['column_date_added'] = htmlspecialchars('Data de cria��o');
		$this->data['column_date_modified'] = htmlspecialchars('Data de modifica��o');
	...
	public function load_products_catalog(){
		...
		$this->data['column_price'] = htmlspecialchars('Pre�o');
